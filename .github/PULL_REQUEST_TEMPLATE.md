...
- [ ] My code follows the style guidelines of this project (e.g., `ruff check .` passes)
...
- [ ] BDD tests pass locally (`behave`)
- [ ] Test coverage is maintained or improved (target >= 80%)
- [ ] Any dependent changes have been merged and published in downstream modules
- [ ] I have added a screenshot/GIF of the CLI/TUI changes (if applicable)